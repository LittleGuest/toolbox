...
const routes = [
  ...
  { path: "/systemMonitor", component: () => import("@/views/SystemMonitor/index.vue") },
  {
    path: "/codeSnippet",
  ...
  {
    path: "/transform/openapi",
    component: () => import("@/views/transform/OpenApi.vue"),
  },
  ...
  {
    path: "/encodedecode/base64text",
    component: () => import("@/views/encodedecode/Base64Text.vue"),
  },
  {
  ...
  {
    path: "/generator/checksum",
    component: () => import("@/views/generator/Checksum.vue"),
  },
  {
