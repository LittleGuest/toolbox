  ...
  <el-form label-position="right" label-width="100px" style="max-width: 460px">
    ...
    <el-form-item label="Decimal">
      ...
      <el-button
        type="primary"
        :icon="CopyDocument"
        v-on:click="copy(decimal)"
      />
    </el-form-item>

    <el-form-item label="Octal">
      <el-text class="mx-1">{{ octal }}</el-text>
      <el-button type="primary" :icon="CopyDocument" v-on:click="copy(octal)" />
    </el-form-item>
